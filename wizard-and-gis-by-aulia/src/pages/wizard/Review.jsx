...
export default function Review(props) {
    ...
    return (
        <div className="container mx-auto bg-white rounded-xl shadow border p-8 m-10">
            ...
            <div class="grid grid-cols-2 pl-20" id="report">
                ...
                <img className="img-review object-top-right" src="https://osm.gs.mil/images/screenshots/slippymap.png" alt="Map Screenshot" />
                <div className='pt-4'>
